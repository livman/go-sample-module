...
var file_pingpong_proto_rawDesc = []byte{
	...
	0x12, 0x0e, 0x67, 0x6f, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65,
	...
	0x73, 0x61, 0x67, 0x65, 0x32, 0x43, 0x0a, 0x08, 0x50, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6e, 0x67,
	0x12, 0x37, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x72, 0x74, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x14, 0x2e,
	0x67, 0x6f, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2e, 0x50,
	0x69, 0x6e, 0x67, 0x1a, 0x14, 0x2e, 0x67, 0x6f, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x2e, 0x50, 0x6f, 0x6e, 0x67, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62,
...
var file_pingpong_proto_goTypes = []interface{}{
	(*Ping)(nil), // 0: gosamplemodule.Ping
	(*Pong)(nil), // 1: gosamplemodule.Pong
}
var file_pingpong_proto_depIdxs = []int32{
	0, // 0: gosamplemodule.PingPong.StartPing:input_type -> gosamplemodule.Ping
	1, // 1: gosamplemodule.PingPong.StartPing:output_type -> gosamplemodule.Pong
...
func (c *pingPongClient) StartPing(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
	err := c.cc.Invoke(ctx, "/gosamplemodule.PingPong/StartPing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PingPong_StartPing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gosamplemodule.PingPong/StartPing",
	}
...
var _PingPong_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gosamplemodule.PingPong",
